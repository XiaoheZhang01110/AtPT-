...
- 工作流将在2026-08-17赫尔辛基时间06:30（UTC 03:30、北京时间11:30）自动执行一次`full_capture`；
- GitHub cron不支持年份，因此工作流另设日期门控，只允许2026-08-17的定时任务进入正式采集，防止以后年度重复运行；
- 手动运行入口继续保留，供端点测试或本次自动任务未达到连续10班时补采；
