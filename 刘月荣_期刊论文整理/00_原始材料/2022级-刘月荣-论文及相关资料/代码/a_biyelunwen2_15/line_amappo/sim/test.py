...
# 横坐标数据，代表站点
stops = list(range(1, 40))
# 纵坐标数据，代表乘客到达率
# passenger_arrival_rates = [0.1 / 60, 0.5 / 60, 0.1 / 60, 0.6/ 60, 0.4 / 60, 0.1 / 60, 0.5 / 60, 0.7 / 60, 0.2 / 60, 0.1 / 60,
...
passenger_arrival_rates = [0.1 , 0.5 , 0.1 , 0.6, 0.4 , 0.1 , 0.5 , 0.7 , 0.2 , 0.1,
             0.4 , 0.3 , 0.2 , 1.0 , 1.5 , 0.8 , 1.4, 0.4 , 0.7, 0.3 ,
             1.1 , 1.2, 0.7 , 0.3 ,0.6 , 0.9, 0.5 , 0.8 , 0.2 , 0.3,
             0.6 , 0.5 , 0.3 , 0.2 , 0.1 , 0.8 , 0.3, 0.2 , 0.0]

# 绘制柱状图
plt.bar(stops, passenger_arrival_rates,color=(1, 0.7, 0.5))
plt.xticks(stops, [str(i) for i in stops])
# 设置x轴标签
plt.xlabel('公交站点编号')
# 设置y轴标签
plt.ylabel('乘客到达率 (人/min)')
# 设置图表标题
# plt.title('各个公交站点的乘客到达率')
