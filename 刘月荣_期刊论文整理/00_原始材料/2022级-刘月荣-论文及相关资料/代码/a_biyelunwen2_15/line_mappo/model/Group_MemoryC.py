...
class Memory():
    ...
    def remember(self, state,fp, action, action_log_prob, reward, next_state,next_value,member_id):
        self.experience+=1
        self.memory[member_id].append((state,fp, action,action_log_prob, reward, next_state,next_value))
